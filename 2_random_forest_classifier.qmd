...
2. train RF classifier model as usual (imbalanced dataset of actives and inactives) - Using similar set of training data as last post but not exactly the same as using chembl_downloader this time to extract data

3. Two approaches from GHOST paper (main idea was shifting decision threshold)
...
4. shift decision threshold using ghostml - postprocessing way 

5. Visualisations - confusion matrix with precision scores
...
*Note: following section was the old data splits - to be removed*

---Old data splits into arrays begins---
...
---Old data splits into arrays ends---

---New data splits begins---
...
```{python}
# Initial problem with y_test - only one label in it (1 only), needs binary labels (0 & 1) 
...
**TODO**
* Adding/changing to ThOpt_metrics = "ROC" code (different to the ref notebook)
* Best to add a bit of explanation of ROC
...
I tried using two different approaches in the training and testing data splits, where one was based on the commonly used random data splits, train_test_splits(), and the other one was the max phase splits, which was based on what I did in the decision tree series by splitting compounds based on max phase assignment of null or 4.

<br>

###### **Preparing max phase-splitted training data**
...
###### **Training model with max phase-splitted training dataset** 
...
###### **Preparing max phase-splitted testing data**
...
###### **Using trained model for prediction on max phase-splitted testing data**
...
###### **Accuracy of model based on max phase-splitted data**

This step of checking accuracy of the model on both the training and testing data was actually recommended to occur before moving onto the feature importances. A *scikit-learn* explanation for this could be found in the [Permutation feature importance section](https://scikit-learn.org/stable/modules/permutation_importance.html#permutation-feature-importance).
...
###### **Preparing randomly splitted training data**

...
##### **Model performance evaluation/hyperparameter tuning**
...
# Use the same training dataset as above - X_mp4, y_mp4
X = X_mp4
y = y_mp4
...
def evaluate(model, X, y):
    ...
    # Since estimator/model was based on DecisionTreeRegressor, using r2 metric
    # n_jobs = -1 meaning using all processors to run jobs in parallel
    scores = cross_val_score(model, X, y, scoring="r2", cv=cross_val, n_jobs=-1)
    return scores

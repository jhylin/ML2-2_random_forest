...
**Might need to move this after "Feature importances" section**
...
```{python}
# Convert the feature_imp arrays into dataframe
...
# Sort the values of feature importances in descending order (high to low)
...
Another plotting method via Matplotlib was shown here which was probably a bit more straightforward as less code were used (but without axes named and also un-sorted).
